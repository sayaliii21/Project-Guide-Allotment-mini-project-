...
<div class="topnav">
  ...
  <a  class="active" href="student_profile_new.php">Profile</a>
...
<div class="row">			
					<div class="form-group">
						...
						<?php echo $_SESSION['project_topic'] ?>
					</div>
				</div>
				<hr>
<div class="row">			
	...
	<div class="row">
					<div class="col-md-12">
						...
						<button onclick="location.href='domain_matching.php'" type="button" name="next" class="btn btn-warning" >Next</button> &nbsp; &nbsp;
						<button onclick="location.href='student_profile.php'" type="button" name="edit" class="btn btn-warning">Edit</button>
						</center>
					</div>
				</div>
			</div>
